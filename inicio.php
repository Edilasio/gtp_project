...
<html lang="es">
  ...
  <body class="undernavigation">
      ...
      <header class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="container">
              <?php include('layout/es/header.php'); ?>
          </div>
         ...
         <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                  ...
                  <?php 
                      if (isset($_GET['p']) == '') {
                        include('pages/es/body-es.php');
                      }
                      else if( $_GET['p'] == "persona" )
                      {
                           include('pages/es/personas.php');                      
                      }
                      else if( $_GET['p'] == "contacto" )
                      {
                           include('pages/es/contacto.php');                      
                      }
                      else if( $_GET['p'] == "servicios" )
                      {
                           include('pages/es/servicios.php');                      
                      }                                                    
                  ?>                 
              ...
              <div class="col-md-3">                
                <?php include('layout/es/sidebar.php'); ?>
              </div>
      ...
      <footer style="background-color: #CCD3D6;">
            <?php include('layout/es/footer.php') ?>                    
      </footer>
