...
<html lang="fr">
  ...
  <body class="undernavigation">
      ...
      <header class="navbar navbar-inverse navbar-fixed-top">
          ...
          <div class="container">
              <?php include('layout/fr/header.php'); ?>
          </div>
         ...
         <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-9">
                  ...
                  <?php 
                      if (isset($_GET['p']) == '') {
                        include('pages/fr/body-fr.php');
                      }
                      else if( $_GET['p'] == "personnel" )
                      {
                           include('pages/fr/personnel.php');                      
                      }
                      else if( $_GET['p'] == "contacts" )
                      {
                           include('pages/fr/contacts.php');                      
                      }
                      else if( $_GET['p'] == "services" )
                      {
                           include('pages/fr/services.php');                      
                      }                                                   
                  ?>                 
              ...
              <div class="col-md-3">                
                <?php include('layout/fr/sidebar.php'); ?>
              </div>
      ...
      <footer style="background-color: #CCD3D6;">
            <?php include('layout/fr/footer.php') ?>                    
      </footer>
